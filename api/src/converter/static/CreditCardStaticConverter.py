...
def overrideDefaultValues(instance, objectKeys=None):
    ...
    instance.expirationDate = None if ObjectHelper.isNone(instance.expirationDate) else DateTimeHelper.dateOf(dateTime=addTimePortiomToDateAsStringIfNeeded(instance.expirationDate))
...
def addTimePortiomToDateAsStringIfNeeded(date):
